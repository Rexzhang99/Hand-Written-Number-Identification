...
#
epochs=10
# with open("Result/nist_tests_keras.csv", "w") as fh_out:
#     for hidden_nodes in [20, 50, 100, 150, 250, 500]:
#         for activation in ['softmax','relu']:
#             for batch_size in [100, 200, 300]:
#                 for loss in ['mean_squared_error','categorical_crossentropy']:
#                     for learning_rate in [0.001,0.01]:
#                         model = Sequential()
#                         model.add(Dense(hidden_nodes, activation=activation, input_shape=(784,)))
...
#                             outstr = str(hidden_nodes) + " " + str(activation) + " " + str(batch_size)+ " " + str(loss)+ " " + str(learning_rate)
